...
import com.example.foldergallery.activity.NotificationCategorySelectionActivity;
...
//import com.example.notifymypic.Activity.NotificationCategorySelectionActivity;
...
public class NotificationCategorySelectionAdapter extends RecyclerView.Adapter<NotificationCategorySelectionAdapter.Holder> {
    NotificationCategorySelectionActivity context;
    ArrayList<CatDataListVariableModel> arrhorizontalFrames;
    ...
    public NotificationCategorySelectionAdapter(NotificationCategorySelectionActivity context,
                                                ArrayList<CatDataListVariableModel> arrhorizontalFrames) {
    ...
    public void onBindViewHolder(final Holder holder, final int position) {
        final CatDataListVariableModel imageModel = arrhorizontalFrames.get(position);
        ...
        holder.title.setText(imageModel.getName());

        Glide.with(context).load(imageModel.getThumbImg()).into(holder.thumbnail);
    ...
    class Holder extends RecyclerView.ViewHolder {
        ...
        ImageView ivDownloadImageIncomplete, ivDownloadImageComplete;
    ...
    class loaderAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            intent.putExtra("activityIsFrom", "NotificationCategorySelectionAdapter");
    ...
    private void exitAlertDialog() {
        ...
        Typeface face = Typeface.createFromAsset(context.getAssets(), "Comfortaa-Regular.ttf");
        CustomTFSpan tfSpan = new CustomTFSpan(face);
        SpannableString spannableString = new SpannableString("Stop download ?");
        spannableString.setSpan(tfSpan, 0, spannableString.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        builder.setTitle(spannableString);
        SpannableString ss = new SpannableString("Are you sure want to stop dowloading processs ?");
        ss.setSpan(tfSpan, 0, ss.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        builder.setMessage(ss);
        builder.setCancelable(false);
        builder.setPositiveButton(context.getResources().getString(R.string.yes),
